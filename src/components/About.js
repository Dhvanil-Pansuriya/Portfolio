...
const About = ({ personalInfo, interests, education }) => {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 relative z-10">
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 md:gap-10 lg:gap-12 items-start">
                  ...
                  >
                    <div className="flex items-center gap-3 sm:gap-4">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 bg-gradient-to-r from-secondary-500 to-accent-500 flex items-center justify-center shadow-lg">
                        <Icon name={stat.icon} size={18} className="text-white sm:w-5 sm:h-5 md:w-6 md:h-6" />
                      </div>
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-gray-600 font-medium text-xs sm:text-sm truncate">{stat.label}</p>
                      </div>
                    </div>
                  </motion.div>
                ))}
            ...
            <motion.div variants={itemVariants} className="lg:col-span-4 xl:col-span-5">
              <div className="space-y-4 sm:space-y-6">
                <div className="bg-white/90 backdrop-blur-sm border border-white/20 shadow-lg p-6 sm:p-8">
                  <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 flex items-center gap-2 sm:gap-3">
                    <Icon name="code" size={20} className="text-secondary-500 sm:w-6 sm:h-6" />
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    {education && education.length > 0 ? (
                      education.map((edu, index) => (
                        <div key={index} className="flex items-start gap-2 sm:gap-3 p-3 sm:p-4 bg-secondary-50">
                          <Icon name="graduation-cap" size={16} className="text-secondary-500 mt-1 sm:w-5 sm:h-5" />
                          <div className="min-w-0 flex-1">
                            <h4 className="font-semibold text-gray-800 text-sm sm:text-base truncate">{edu.degree}</h4>
                            <p className="text-gray-600 text-sm truncate">{edu.institution}</p>
                            <p className="text-xs sm:text-sm text-gray-500 truncate">{edu.duration} • {edu.grade}</p>
                          </div>
                        </div>
                      ))
                    ) : (
                      <div className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-secondary-50">
                        <Icon name="graduation-cap" size={16} className="text-secondary-500 sm:w-5 sm:h-5" />
                        <div className="min-w-0 flex-1">
                          <h4 className="font-semibold text-gray-800 text-sm sm:text-base">Education</h4>
                          <p className="text-gray-600 text-sm">{personalInfo.education}</p>
                        </div>
                      </div>
                    )}
                  </div>
                ...
                >
                  <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3">
                    <Icon name="heart" size={20} className="text-accent-500 sm:w-6 sm:h-6" />
            ...
            <motion.div variants={itemVariants} className="lg:col-span-4 xl:col-span-4">
              <div className="space-y-4 sm:space-y-6">
                {/* Skills Highlight */}
                <motion.div
                ...
                >
                  <h4 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-secondary-700 flex items-center gap-2 sm:gap-3">
                    <Icon name="lightbulb" size={20} className="text-accent-500 sm:w-6 sm:h-6" />
                  ...
                  <ul className="space-y-3 sm:space-y-4 text-gray-600">
                    <li className="flex items-start gap-2 sm:gap-3">
                      ...
                      <div className="min-w-0">
                        <span className="font-semibold text-gray-800 text-sm sm:text-base">Clean, maintainable code</span>
                        <p className="text-xs sm:text-sm text-gray-600 mt-1">Writing code that's easy to read, understand, and maintain</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-2 sm:gap-3">
                      <div className="w-2 h-2 bg-secondary-500 rounded-full mt-2 flex-shrink-0"></div>
                      <div className="min-w-0">
                        <span className="font-semibold text-gray-800 text-sm sm:text-base">Modern development practices</span>
                        <p className="text-xs sm:text-sm text-gray-600 mt-1">Following industry best practices and latest technologies</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-2 sm:gap-3">
                      <div className="w-2 h-2 bg-secondary-500 rounded-full mt-2 flex-shrink-0"></div>
                      <div className="min-w-0">
                        <span className="font-semibold text-gray-800 text-sm sm:text-base">Responsive & user-friendly designs</span>
                        <p className="text-xs sm:text-sm text-gray-600 mt-1">Creating interfaces that work seamlessly across all devices</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-2 sm:gap-3">
                      <div className="w-2 h-2 bg-secondary-500 rounded-full mt-2 flex-shrink-0"></div>
                      <div className="min-w-0">
                        <span className="font-semibold text-gray-800 text-sm sm:text-base">Continuous learning mindset</span>
                        <p className="text-xs sm:text-sm text-gray-600 mt-1">Always staying updated with emerging technologies and trends</p>
                      </div>
                    </li>
                  </ul>
                </motion.div>
                ...
                >
                  <h4 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-primary-700 flex items-center gap-2 sm:gap-3">
                    <Icon name="bullseye" size={20} className="text-primary-500 sm:w-6 sm:h-6" />
                    <span className="truncate">My Approach</span>
                  </h4>
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex items-start gap-2 sm:gap-3">
                      <Icon name="check-circle" size={16} className="text-green-500 mt-1 sm:w-5 sm:h-5" />
                      <div className="min-w-0">
                        <h5 className="font-semibold text-gray-800 text-sm sm:text-base">Problem-Solving First</h5>
                        <p className="text-xs sm:text-sm text-gray-600">Understanding the core problem before jumping into solutions</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-2 sm:gap-3">
                      <Icon name="check-circle" size={16} className="text-green-500 mt-1 sm:w-5 sm:h-5" />
                      <div className="min-w-0">
                        <h5 className="font-semibold text-gray-800 text-sm sm:text-base">User-Centric Design</h5>
                        <p className="text-xs sm:text-sm text-gray-600">Prioritizing user experience in every development decision</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-2 sm:gap-3">
                      <Icon name="check-circle" size={16} className="text-green-500 mt-1 sm:w-5 sm:h-5" />
                      <div className="min-w-0">
                        <h5 className="font-semibold text-gray-800 text-sm sm:text-base">Quality Assurance</h5>
                        <p className="text-xs sm:text-sm text-gray-600">Thorough testing and optimization for peak performance</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
