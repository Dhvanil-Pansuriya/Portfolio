...
const SEO = ({
  ...
  useEffect(() => {
    ...
    updateMetaTag(
      "og:title",
      title || `Hardik Ramoliya - ${currentThemeInfo.name} Developer`,
      true
    );
    updateMetaTag(
      "og:description",
      description || `Professional ${currentThemeInfo.name} Developer`,
      true
    );
    ...
    const structuredData = {
      ...
      sameAs: [
        "https://linkedin.com/in/hardik-ramoliya-r",
        "https://github.com/hardik-ramoliya-r",
      ],
...
const getSkillsForTheme = (theme) => {
  const skills = {
    ...
    ios: ["iOS Development", "Swift", "SwiftUI", "UIKit", "Core Data", "Xcode"],
  };
