...
const Skills = ({ skills }) => {
  ...
  const getSkillIcon = (skill) => {
    ...
    const skillIconMap = {
      ...
      flutter : { name: "flutter", className: "text-blue-400" },
      stripe : { name: "stripe", className: "text-purple-500" },
      "vs code" : { name: "vscode", className: "text-blue-600" },
      "google play console" : { name: "google-play", className: "text-blue-500" },
      "ai integration" : { name: "artificial-intelligence", className: "text-yellow-600" },
      "cursor" : { name: "cursor", className: "text-purple-500" },
      "compose ui" : { name: "android", className: "text-green-600" },
      "google maps" : { name: "google-maps", className: "text-green-500" },
      "human interface guidelines" : { name: "apple", className: "text-gray-700" },
      asana : { name: "asana", className: "text-pink-600" },
      jira : { name: "jira", className: "text-blue-700" },
      trello : { name: "trello", className: "text-blue-500" },
      "google play closed beta tester" : { name: "google-play", className: "text-blue-500" },
      "google play open beta tester" : { name: "google-play", className: "text-blue-500"},
      "remote test lab (samsung, genymotion)" : { name: "iphone", className: "text-gray-600" },
      browserstack : { name: "browser", className: "text-blue-500" },
      axios : { name: "axios", className: "text-blue-600" },
      tailwind : { name: "tailwind", className: "text-blue-400" },
      zustand : { name: "react", className: "text-purple-600" },
      dayjs : { name: "javascript", className: "text-yellow-500"},
      momentjs : { name: "javascript", className: "text-yellow-500"},
      'native base': { name: 'react', className: 'text-blue-500'},
      'jwt authentication': { name: 'auth', className: 'text-green-600'},
      'geo location api': { name: 'globe', className: 'text-blue-500' },
      'ble manager': { name: 'manager', className: 'text-purple-500'},
      gson : { name: "code", className: "text-green-500"},
      'hilt/dagger' : { name: 'android', className: 'text-purple-600'},
      workmanager : { name: 'manager', className: 'text-green-600'},
      'lottie animations' : { name: 'animation', className: 'text-blue-400' },
      'glide/coil image loading' : { name: 'image', className: 'text-purple-500'},
      realmdb : {name : "database", className : " text-yellow-500"},
      mmkv : { name: 'video', className: 'text-red-500'},
      'clean architecture' : {name : 'architecture', className : 'text-green-500'}
    };
